...
$(document).ready(function ()
{
	...
	$(".output-select > button").click(function ()
	{
		...
		// Remove the button that currently is selected
		var possibleBtns = $(this).parent().find($("button.selected"));
		console.dir(possibleBtns);
		$(possibleBtns[0]).removeClass("selected");
